...
public class APIExamFace {
    ...
    public static void main(String[] args) {
        ...
        String clientId = "5n0da3ijJ0znmBDIO3ar";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "RHX0nWrl65";//애플리케이션 클라이언트 시크릿값";

        try {
            String paramName = "image"; // 파라미터명은 image로 지정
            String imgFile = "C:\\Users\\PC-09\\Desktop\\images\\dd.jpg";
