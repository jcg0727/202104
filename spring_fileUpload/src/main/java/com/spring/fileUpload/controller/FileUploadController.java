...
public class FileUploadController {
	...
	public String uploadByMultipartFile(@RequestParam(value="title", defaultValue="제목없음") String title, 
										@RequestParam("file") MultipartFile multi, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception{
		...
		if(multi.isEmpty()) {
			...
			out.println("<script>alert('파일이없습니다.!');</script>");
