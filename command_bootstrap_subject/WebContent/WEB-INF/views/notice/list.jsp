   				...
   				<div id="keyword" class="card-tools" style="width:550px;">
   					 <div class="input-group row">	
   					 	...
   					 	<option value="" ${cri.searchType eq '' ? 'selected' : ''}>검색구분</option>
   					 		<option value="" ${cri.searchType eq 'w' ? 'selected' : ''}>작성자</option>
   					 		<option value="i" ${cri.searchType eq 't' ? 'selected' : ''}>제목</option>
   					 	</select>
	             ...
	             <div class="col-sm-12">	
		    		...
		    		<table class="table table-bordered">
		              ...
		              <c:forEach var="notice" items="${noticeList }" >
		               	...
		               	<td id="nno" name="nno">${notice.nno}</td>
		               	<td>${notice.title}</td>
		               	<td>${notice.writer}</td>
		               	<td><fmt:formatDate value="${notice.regdate}" pattern="yyyy-MM-dd" /></td>
		               	<td><button class="btn btn-primary" onclick="noticeView('${notice.nno}')">상세보기</button></tr>
		               	<tr>
		              </c:forEach>
...
<script>
	...
	function noticeView(nno){
		   var UrlStr = 'noticeView.do?nno=' + nno;
		   var WinTitle= '상세보기';
		   var WinWidth = 800;
		   var WinHeight = 700;
