...
public class MailController {
	...
	public ModelAndView mailPost(@ModelAttribute("mailRequest") MailRequestCommand mailReq, HttpServletRequest request, ModelAndView mnv) throws Exception{
		...
		if(attach!=null & !attach.isEmpty()) {
			...
			if(attach.getSize()<1024*1024*5) {
				...
				url="member/mail_fail";
				mnv.addObject("message","첨부파일 용량초과 입니다.");
			}
